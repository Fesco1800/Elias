...
if (!defined('ALLOWED_INACTIVITY_TIME'))        define('ALLOWED_INACTIVITY_TIME', time()+ 60*60);
...
if (!defined('MAIL_USERNAME'))                  define('MAIL_USERNAME', 'example');
if (!defined('MAIL_PASSWORD'))                  define('MAIL_PASSWORD', 'example');
